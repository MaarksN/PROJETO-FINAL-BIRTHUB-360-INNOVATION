...
|---|---|---|---|---|
| Sucesso Nominal | Request com `targetRetentionPct` e segmentos validos. | Status `success` e schema valido com score projetado de retencao e frente de intervencao recomendada. | Validar contra `ChurnDeflectorOutputSchema`. | Testes de unit e schema aprovados. |
