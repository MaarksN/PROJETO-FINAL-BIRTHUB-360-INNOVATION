# Release Scorecard
Generated at: 2026-04-19T02:40:44.177Z
...
| --- | --- | --- | --- |
| Workspace audit | FAIL | Workspace audit failed | `scripts/ci/workspace-audit.mjs` |
...
| Dead code regression | FAIL | Current=304, regressions=304 | `artifacts/quality/dead-code/knip-report.json`, `docs/evidence/dead-code-report.md`, `artifacts/quality/knip-baseline.json` |
...
| Score threshold | FAIL | Score 40 is below minimum 100 | - |