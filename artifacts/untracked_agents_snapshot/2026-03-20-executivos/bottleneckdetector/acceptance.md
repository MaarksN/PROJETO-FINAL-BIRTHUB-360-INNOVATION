...
# BottleneckDetector - Acceptance Criteria

| Critério | Input mínimo | Output esperado | Como verificar | Evidência |
|---|---|---|---|---|
| Sucesso Nominal | Request com target de desempenho e janela temporal preenchida. | Status `success` e schema valido com gargalos priorizados e acoes de mitigacao. | Validar contra `BottleneckDetectorOutputSchema`. | Testes de unit e schema aprovados. |
