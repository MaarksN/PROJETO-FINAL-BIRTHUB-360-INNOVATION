...
# ResourceBalancer - Acceptance Criteria

| Critério | Input mínimo | Output esperado | Como verificar | Evidência |
|---|---|---|---|---|
| Sucesso Nominal | Request com alvo de balanceamento e segmentos definidos. | Status `success` e schema valido com recomendacoes de rebalanceamento e impacto de capacidade. | Validar contra `ResourceBalancerOutputSchema`. | Testes de unit e schema aprovados. |
