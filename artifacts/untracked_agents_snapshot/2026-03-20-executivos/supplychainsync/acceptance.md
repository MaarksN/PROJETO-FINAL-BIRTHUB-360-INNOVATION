...
# SupplyChainSync - Acceptance Criteria

| Critério | Input mínimo | Output esperado | Como verificar | Evidência |
|---|---|---|---|---|
| Sucesso Nominal | Request com alvo de sincronizacao e segmentos operacionais definidos. | Status `success` e schema valido com sinais de risco de capacidade e plano de sincronizacao. | Validar contra `SupplyChainSyncOutputSchema`. | Testes de unit e schema aprovados. |
