...
export const SupplyChainSyncInputSchema = z
  .object({
    constraints: z
      .object({
  ...
  .strict();
export type SupplyChainSyncInput = z.infer<typeof SupplyChainSyncInputSchema>;
...
export const MarketEventNameSchema = z.enum([
  "supplychainsync.request.received",
  "supplychainsync.contract.loaded",
  "supplychainsync.tool.call.started",
  "supplychainsync.tool.call.succeeded",
  "supplychainsync.tool.call.failed",
  "supplychainsync.retry.scheduled",
  "supplychainsync.fallback.applied",
  "supplychainsync.response.generated"
]);
...
export const SupplyChainSyncContractSchema = z
  .object({
  ...
  .strict();
export type SupplyChainSyncContract = z.infer<typeof SupplyChainSyncContractSchema>;

export const DEFAULT_TRENDCATCHER_CONTRACT: SupplyChainSyncContract = {
...
export const SupplyChainSyncOutputSchema = z
  .object({
    agent: z.literal("SupplyChainSync"),
  ...
  .strict();
export type SupplyChainSyncOutput = z.infer<typeof SupplyChainSyncOutputSchema>;
