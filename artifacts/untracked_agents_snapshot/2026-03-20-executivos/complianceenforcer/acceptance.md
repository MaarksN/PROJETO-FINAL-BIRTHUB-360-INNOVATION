...
# ComplianceEnforcer - Acceptance Criteria

| Critério | Input mínimo | Output esperado | Como verificar | Evidência |
|---|---|---|---|---|
| Sucesso Nominal | Request com obrigacoes e janela de controle definidos. | Status `success` e schema valido com plano de conformidade recomendado e sinais de risco. | Validar contra `ComplianceEnforcerOutputSchema`. | Testes de unit e schema aprovados. |
