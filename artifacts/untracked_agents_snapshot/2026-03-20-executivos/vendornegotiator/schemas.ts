...
export const VendorNegotiatorInputSchema = z
  .object({
    constraints: z
      .object({
  ...
  .strict();
export type VendorNegotiatorInput = z.infer<typeof VendorNegotiatorInputSchema>;
...
export const BudgetEventNameSchema = z.enum([
  "vendornegotiator.request.received",
  "vendornegotiator.contract.loaded",
  "vendornegotiator.tool.call.started",
  "vendornegotiator.tool.call.succeeded",
  "vendornegotiator.tool.call.failed",
  "vendornegotiator.retry.scheduled",
  "vendornegotiator.fallback.applied",
  "vendornegotiator.response.generated"
]);
...
export const VendorNegotiatorContractSchema = z
  .object({
  ...
  .strict();
export type VendorNegotiatorContract = z.infer<typeof VendorNegotiatorContractSchema>;

export const DEFAULT_BUDGETFLUID_CONTRACT: VendorNegotiatorContract = {
...
export const VendorNegotiatorOutputSchema = z
  .object({
    agent: z.literal("VendorNegotiator"),
    budgetBrief: z
      .object({
  ...
  .strict();
export type VendorNegotiatorOutput = z.infer<typeof VendorNegotiatorOutputSchema>;
