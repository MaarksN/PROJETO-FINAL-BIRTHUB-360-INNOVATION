...
# VendorNegotiator - Acceptance Criteria

| Critério | Input mínimo | Output esperado | Como verificar | Evidência |
|---|---|---|---|---|
| Sucesso Nominal | Request com alvo de eficiencia e janela de negociacao definida. | Status `success` e schema valido com recomendacoes de alavanca contratual e impacto esperado. | Validar contra `VendorNegotiatorOutputSchema`. | Testes de unit e schema aprovados. |
