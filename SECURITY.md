...
Aplicamos patches de segurança com prioridade para as versões atualmente rodando em nosso monorepo (principal branch `main` liberada pelo lane canônico `GitHub Actions + Render` e versões estáveis das nossas APIs).
