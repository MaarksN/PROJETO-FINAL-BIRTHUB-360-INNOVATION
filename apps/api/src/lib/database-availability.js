import { getEnvironmentSource, readEnvironmentValue, readTrimmedEnvironmentValue } from "@birthub/config";
const DEFAULT_DEVELOPMENT_DATABASE_URL = "postgresql://postgres:postgres@localhost:5432/birthub?schema=public";
function isImplicitDevelopmentFallback(databaseUrl) {
    try {
...
export function hasExplicitDatabaseUrl(env = getEnvironmentSource()) {
