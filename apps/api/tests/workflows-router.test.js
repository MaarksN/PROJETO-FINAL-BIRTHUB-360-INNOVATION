...
void test("workflows router lists revisions for the active tenant", async () => {
    ...
    let receivedOrganizationLookup = null;
    let receivedRevisionLookup = null;
    const restores = [
        ...
        stubMethod(prisma.workflowRevision, "findMany", (args) => {
...
void test("workflows router reverts a revision using the authenticated tenant scope", async () => {
    ...
    let receivedRevisionLookup = null;
    let receivedTransactionUpdate = null;
    let receivedTransactionCreate = null;
    let receivedTransitionDelete = null;
    let receivedStepDelete = null;
    const receivedStepCreates = [];
    ...
    const restores = [
        ...
        stubMethod(prisma.workflow, "findFirst", (_args) => {
        ...
        stubMethod(prisma.workflowRevision, "findUnique", (args) => {
            receivedRevisionLookup = args;
            return Promise.resolve({
                definition: workflowCanvas,
                tenantId: "tenant_1",
