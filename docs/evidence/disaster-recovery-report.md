...
- generatedAt: 2026-04-19T16:11:43.725Z
- overall_status: fail
...
| --- | --- | --- | --- |
| backup health | fail | `artifacts/backups/backup-health.json` | No backup files found in /app/artifacts/backups. |
...
- No backup files found in /app/artifacts/backups.
