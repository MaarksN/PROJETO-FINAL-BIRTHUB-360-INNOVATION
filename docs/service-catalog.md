...
| Legacy/Quarentena | `apps/legacy/dashboard` | Front-end legado | 🔴 Fora de P0, fora do workspace ativo e sem papel de rota principal | Product Frontend | Diretório legado mantido para compatibilidade interna |
