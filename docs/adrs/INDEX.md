...
Este índice registra todas as decisões arquiteturais tomadas no desenvolvimento do BirthHub360.
Qualquer decisão crítica (mudança de infraestrutura, escolha de provedor de nuvem, mudança de framework core) DEVE ser registrada aqui.

| ADR  | Título | Data | Status | Autor |
|------|--------|------|--------|-------|
...
| 0004 | [Deploy Canônico em GitHub Actions + Render](ADR-036-canonical-deploy-platform.md) | 2026-04-07 | Aprovado | @birthub/platform |
