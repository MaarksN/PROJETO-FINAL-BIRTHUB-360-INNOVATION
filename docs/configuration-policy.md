...
- **Justificativa:** Proteção máxima. Acesso restrito a engenheiros SRE/DevOps. Rotação simplificada via cofre/Environment Secrets e novo deploy controlado do lane canônico, sem necessidade de reescrever código.
