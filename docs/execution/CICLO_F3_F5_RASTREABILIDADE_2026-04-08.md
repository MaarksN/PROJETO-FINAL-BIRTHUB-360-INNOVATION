...
| Backup, restore e disaster recovery | Fase 5 | `docs/runbooks/disaster-recovery.md`, `scripts/ops/record-disaster-recovery-drill.ts`, `artifacts/dr/latest-drill.json` | aberto | O runbook e o script existem, mas o artefato atual registra `missing-drill-record`; falta evidencia versionada de backup/restore e drill recente |
...
- `artifacts/dr/latest-drill.json` segue em `missing-drill-record`, confirmando que backup/restore e drill de DR continuam bloqueando o gate operacional.
