...
- Verificar que `apps/web` autentica via `/api/v1/auth/login` e `/api/v1/me`.
- Verificar que `apps/legacy/dashboard` permanece fora do caminho crítico e sem ser usado como cliente canônico.
