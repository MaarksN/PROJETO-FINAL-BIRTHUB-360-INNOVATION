...
- O arquivo de rastreamento `GAP-001_codex.md` contém marcadores de rascunho explícitos.

## Critério para aprovação
- Diretório SDR acessível, LDR perfeitamente simétrico conforme esperado, testes passantes e arquivo `.md` corrigido (sem marcadores de rascunho).
