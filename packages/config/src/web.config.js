import { z } from "zod";
import { mapWebProductCapabilities, webProductCapabilityEnvSchema } from "./product-capabilities.js";
import { deploymentEnvironmentSchema, envBoolean, EnvValidationError, hasPlaceholderMarker, isLocalUrl, isSecureHttpUrl, optionalNonEmptyString, optionalUrlString, parseEnv, urlString } from "./shared.js";
