...
import { z } from "zod";
import { EnvValidationError, hasPlaceholderMarker, hasRequiredPostgresSsl, hasRequiredRedisTls, nodeEnvSchema, nonEmptyString, optionalNonEmptyString, optionalUrlString, parseEnv, urlString } from "./shared.js";
export const workerEnvSchema = z.object({
    ...
    WORKER_CONCURRENCY: z.preprocess((value) => (typeof value === "string" && value.trim() === "" ? undefined : value), z.coerce.number().int().positive().optional())
});
