...
|---|---|---|---|---|
| Sucesso Nominal | Request com pipeline target valido e janela temporal preenchida. | Status `success` e schema valido com cobertura projetada e deslocamento recomendado. | Validar contra `PipelineOracleOutputSchema`. | Testes de unit e schema aprovados. |
