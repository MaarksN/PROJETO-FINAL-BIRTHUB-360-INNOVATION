...
|---|---|---|---|---|
| Sucesso Nominal | Request com target pricing lift e segmentos alvo. | Status `success` e schema valido com movimento de pricing recomendado e sinais de risco comercial. | Validar contra `PricingOptimizerOutputSchema`. | Testes de unit e schema aprovados. |
