...
void test("createNotificationForUser accepts an injected client", async () => {
  ...
  injectedClient.userPreference.upsert = () =>
    ({
      inAppNotifications: true
    }) as never;
  injectedClient.notification.create = (args: unknown) => {
    createArgs = args;
...
void test("updateUserPreference audits cookie consent transitions", async () => {
  ...
  prisma.auditLog.create = ((args: unknown) => {
    auditPayload = args;
    return Promise.resolve({} as never);
...
void test("updateUserPreference accepts an injected client", async () => {
  ...
  injectedClient.userPreference.findUnique = () =>
    ({
      cookieConsent: "PENDING"
    }) as never;
  injectedClient.userPreference.upsert = () =>
  ...
  injectedClient.auditLog.create = (args: unknown) => {
    auditPayload = args;
    return Promise.resolve({} as never);
  };
...
void test("createNotificationForOrganizationRoles only creates notifications for users with enabled preference", async () => {
  ...
  prisma.notification.createMany = ((args: unknown) => {
    createManyArgs = args;
...
void test("createNotificationForOrganizationRoles accepts an injected client", async () => {
  ...
  injectedClient.membership.findMany = () =>
    [
      {
        role: Role.ADMIN,
        tenantId: "tenant_1",
  ...
  injectedClient.notification.createMany = (args: unknown) => {
    createManyArgs = args;
...
void test("createNotificationForOrganizationRoles caps membership reads", async () => {
  ...
  prisma.membership.findMany = ((args: unknown) => {
    received = args;
    return Promise.resolve([]);
  }) as unknown as typeof prisma.membership.findMany;
...
void test("listNotifications returns bounded items, next cursor and unread count", async () => {
  ...
  prisma.notification.count = (() => Promise.resolve(7)) as unknown as typeof prisma.notification.count;
...
void test("listNotifications accepts an injected client", async () => {
  ...
  injectedClient.notification.findMany = () =>
    [
      { id: "n3" },
      { id: "n2" },
      { id: "n1" }
    ] as never;
  injectedClient.notification.count = () => Promise.resolve(7);
