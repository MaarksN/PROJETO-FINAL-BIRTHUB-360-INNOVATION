import type { Job, JobsOptions, Processor, Queue, QueueEvents, RepeatOptions, Worker } from "bullmq";
...
export type QueueProcessor<DataType = unknown, ResultType = unknown> = (data: DataType, context: JobContext, job: Job<DataType, ResultType, string>) => Promise<ResultType>;
...
export type SerializedJobOptions = Pick<JobsOptions, "attempts" | "backoff" | "delay" | "priority" | "removeOnComplete" | "removeOnFail">;
...
export type RuntimeWorkerHandler<DataType = unknown, ResultType = unknown> = Processor<DataType, ResultType, string>;
