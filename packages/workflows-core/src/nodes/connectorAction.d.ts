...
export declare function executeConnectorActionNode(action: ConnectorActionRequest, context: WorkflowRuntimeContext, executor: ConnectorExecutor): Promise<unknown>;
