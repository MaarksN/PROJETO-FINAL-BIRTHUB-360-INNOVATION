...
function getCyclePath(adjacency, nodeId, visiting, visited, stack) {
...
function assertEdgeEndpoints(nodesById, edge) {
...
function assertNoIsolatedNodes(nodes, edges) {
    if (nodes.length <= 1) {
        return;
    }
...
function assertConnectedFromRoot(rootNodeId, adjacency, nodes) {
...
function topologicalSort(nodes, adjacency, indegreeByNode) {
    const queue = [];
...
export function validateDag(input, options = {}) {
