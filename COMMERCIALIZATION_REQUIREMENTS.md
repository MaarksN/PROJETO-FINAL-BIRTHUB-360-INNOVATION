...
- **[REL-19] Tag Semântica (🟠 ALTO):** A versão de release no código (`package.json`) deve estar atrelada a uma tag do repositório Git para rastreabilidade, rollback e comprovação da release oficial.
